...
const Home = () => <main className="page home-page">
  <section className="hero layout-grid">
    ...
    <div className="hero-visual"><div className="portrait-frame"><img src={ProfileImage} alt="Rishu Singh" /><span className="frame-label">RS // 2024</span></div><div className="orbit orbit-one" /><div className="orbit orbit-two" /><div className="hero-badge"><Sparkles size={15} /><span>code<br /><strong>with intent</strong></span></div></div>
  </section>
</main>;
